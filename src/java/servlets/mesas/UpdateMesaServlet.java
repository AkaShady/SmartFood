 ...
 * @author will
 */
@WebServlet(name = "UpdateMesaServlet", urlPatterns = {"/UpdateMesaServlet"})
public class UpdateMesaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet UpdateMesaServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet UpdateMesaServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    //processRequest(request, response);
        ...
        mesas.setId(Integer.parseInt(request.getParameter("id")));
