 ...
 * @author will
 */
@WebServlet(name = "DeleteMesaServlet", urlPatterns = {"/DeleteMesaServlet"})
public class DeleteMesaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DeleteMesaServlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DeleteMesaServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int id = Integer.parseInt(request.getParameter("id"));
            ...
            try {
                mesasJpaController.destroy(id);
                response.sendRedirect("mesas/List.jsp");
            } catch (RollbackFailureException ex) {
                Logger.getLogger(DeleteMesaServlet.class.getName()).log(Level.SEVERE, null, ex);
            } catch (Exception ex) {
                Logger.getLogger(DeleteMesaServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
